...
export class NotificationLogService {
  ...
  getNextNotificationLog() {
    return this.http.get<NotificationLogVM[]>('https://localhost:7100/api/NotificationLog/').pipe();
  }
  ...
  SearchNotificationLog(nLog): Observable<NotificationLogVM[]> {
    return this.http.post<NotificationLogVM[]>('https://localhost:7100/api/NotificationLog/Search', nLog).pipe();
  }
 
  SaveNotificationLog(nLog): Observable<NotificationLogVM> {
    return this.http.post<NotificationLogVM>('https://localhost:7100/api/NotificationLog', nLog).pipe();
  }
 
  deleteNotificationLog(id) {
    return this.http.delete('https://localhost:7100/api/NotificationLog/' + id);
  }
