...
INSERT INTO `sch` VALUES (1,'44fb345f-be12-4d99-8a0d-f1c5063f4999',NULL,1006002,'2023-09-11 00:00:00',NULL,'2023-09-11 10:00:00',NULL,'2023-09-11 10:00:00',_binary ''),(2,'string','string',0,NULL,0,'2023-09-11 08:11:15',NULL,NULL,_binary ''),(3,'1c75d06f-45f4-4877-b2cd-d88b21091f96',NULL,1006002,NULL,0,'2023-09-11 13:43:03',NULL,NULL,_binary '\0'),(4,NULL,NULL,1006002,NULL,0,'2023-09-11 14:08:54',NULL,NULL,_binary '\0'),(5,'1c75d06f-45f4-4877-b2cd-d88b21091f96',NULL,1006002,NULL,0,'2023-09-11 14:10:21',NULL,NULL,_binary '\0'),(6,NULL,NULL,0,NULL,0,'2023-09-11 15:35:28',NULL,NULL,_binary '\0'),(7,'0a714c07-6881-4740-8bcb-5a6bfd833eda','0fa6617b-be51-4a7d-b8c4-9f90dc841997',0,NULL,0,'2023-09-11 18:03:04',NULL,NULL,_binary '\0');
...
INSERT INTO `schline` VALUES (2,'1003007',0,'2023-09-11 08:11:15',NULL,NULL,_binary '');
...
/*!50001 VIEW `vw_sch` AS select `sch`.`Id` AS `Id`,`sch`.`UserId` AS `UserId`,`aspnetusers`.`UserName` AS `User`,`sch`.`RoleId` AS `RoleId`,`aspnetroles`.`Name` AS `Role`,`sch`.`ScheduleTypeId` AS `ScheduleTypeId`,`scheduletype`.`Name` AS `ScheduleType`,`sch`.`EffectiveDate` AS `EffectiveDate`,`sch`.`CreatedOn` AS `CreatedOn`,`sch`.`CreatedBy` AS `CreatedBy`,`sch`.`ModifiedOn` AS `ModifiedOn`,`sch`.`ModifiedBy` AS `ModifiedBy`,`sch`.`IsActive` AS `IsActive` from (((`sch` left join `aspnetusers` on((`aspnetusers`.`Id` = `sch`.`UserId`))) left join `aspnetroles` on((`aspnetroles`.`Id` = `sch`.`RoleId`))) left join `enumline` `scheduletype` on((`scheduletype`.`Id` = `sch`.`ScheduleTypeId`))) */;
...
-- Dump completed on 2023-09-12 16:39:07
